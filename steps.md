...
7. [Pautan Penting](#7-pautan-penting)
...
| :--- | :--- |
| **Bilangan Bab** | **Minimum 6 bab** bagi setiap judul buku. |
| **Halaman** | **Minimum 100 halaman** keseluruhan. Setiap bab perlu seimbang. |
| **Editor** | Maksimum **2 orang** editor penyelenggara (termasuk staf akademik). |
| **Penulis** | Maksimum **4 orang** penulis per bab. |
| **Judul** | Tidak melebihi **7 perkataan** (mencerminkan tema keseluruhan). |
| **Plagiarisme** | Laporan Turnitin mestilah **< 20%** (Similarity Index). |
...
| **Tema** | Tema buku mestilah mengikat keseluruhan tajuk dan bab. |
...
### Spesifikasi Teks
*   **Font:** Baskerville (Perlu diinstall: `Font_Baskerville.ttc`). Jika ada teks Arab, guna `KFGQPC Uthmanic Script HAFS`.
...
### Rajah & Jadual
*   **Kapsyen Rajah:** Letak di **BAWAH**. Format: **Figure X.1 Title** (Sentence case).
...
*   **Sumber:** Jika bahan diambil dari sumber luar, wajib tulis: *(Source: Author, Year)* atau *(Adapted from: Author, Year)*.

### Rujukan
*   Gunakan gaya **APA Edisi ke-7 (APA 7th Edition)**.
*   Senarai rujukan diletakkan di akhir setiap bab (bukan di akhir buku).
*   Pastikan semua rujukan dalam senarai telah disitasi dalam teks.
...
1.  **Bahagian Awal (Prelims):**
    ...
    *   **Prakata (Preface):** Menjelaskan tujuan, sasaran pembaca, skop, dan struktur buku.
    *   **Senarai Penyumbang:** Nama penuh dan afiliasi penulis.

2.  **Bahagian Teks (Chapters):**
    *   **Bab 1:** Pengenalan oleh Editor (Overview).
    *   **Bab-bab seterusnya:** Isi kandungan teknikal/kajian.

3.  **Bahagian Akhiran (End Matter):**
    *   **Indeks:** Senarai kata kunci penting berserta nombor muka surat. Disarankan guna fungsi *Mark Entry* di MS Word.
...
1.  **Daftar Akaun:** Layari [UTM E-Press](https://epress.utm.my/) dan daftar.
2.  **Pilih Kategori:** Pilih "UTM Press - Edited Book".
3.  **Muat Naik Fail:**
    *   Manuskrip lengkap (Word) - Boleh dipecahkan ikut bab atau satu fail.
    *   Borang Cadangan (*Proposal Form*).
    *   CV Editor & CV Penilai (*Reviewer*).
    *   Laporan Turnitin (<20%).
    *   Borang Kebenaran (*Permission Verification*) jika ada bahan hak cipta lain.
    *   Abstrak Buku & Abstrak Bab.
...
### ✍️ Panduan & Rujukan
*   [APA Style Common Reference Examples Guide (PDF)](https://apastyle.apa.org/instructional-aids/reference-examples.pdf)
